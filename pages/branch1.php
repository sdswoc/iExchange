...
<head>
    ...
    <![endif]-->
    <?php
        $_SESSION['branchName']='CSE'; //any Branch
    ?> 
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12 stick">
                    <h1 class="page-header">Branch: <?php
                    echo $_SESSION['branchName'];
                    ?><!-- can be found using php-->:</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-green">
                            ...
                            --><a data-toggle="collapse" data-parent="#accordion" href="#collapseOne"><i class="fa fa-hand-o-right"></i></a><h4 class="panel-title">  <a href="Thread.php">Project #1</a></h4>
                                </h4>
                            </div>
                            <div id="collapseOne" class="panel-collapse collapse in">
                                <div class="panel-body">
                                About The professors and the students involved date start 
                                and about the project (abstract)
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <h4 class="panel-title"><!--
                            --><a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"><i class="fa fa-hand-o-right"></i></a><h4 class="panel-title">  <a href="branch1.html">Project #2</a></h4>
                                </h4>
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <h4 class="panel-title"><!--
                            --><a data-toggle="collapse" data-parent="#accordion" href="#collapseThree"><i class="fa fa-hand-o-right"></i></a><h4 class="panel-title">  <a href="branch1.html">Project #3</a></h4>
                                </h4>
                            </div>
