            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li class="active"><a href="profile.php"><i class="fa fa-user fa-fw"></i> User Profile</a>
                        </li>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <ul>
                                        <li>
                                            ...
                                            <input type ="number" style="width:320px; display: inline;" class="form-control" value=<?php
                                        ...
                                        <li>
                                            <label>NAME</label>
                                            <input class="form-control" style="width:320px; display: inline;" value=<?php
                                        ...
                                        <li>
                                            <label>ID</label>
                                            <input class="form-control" style="width:250px; display: inline;" value=<?php
                                                echo '"'.$row['userId'].'"';
                                            ?> disabled>
                                        ...
                                        <li>
                                            ...
                                            ?> disabled style="width:320px; display: inline;" ><p> </p>
                                        </li>
                                    </ul>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6" style="display: flex; justify-content: center;">
                                    <?php
                                        echo '<img src="../Profile_Photos/file'.$_SESSION['userEnrollment'].'.jpg" height="166" width="166">';
                                    ?>
                                </div>
                            </div>
                            <!-- /.row (nested) -->
